...
import logging
from .backend import get_link_token, get_access_token, get_transactions, get_holdings
from hayback.models.operations import set_plaid_account_cred
import plaid
...
# returns the link token for the user
    def post(self):
        ...
        print(access_token)
        return (access_token, item_id), 200
        #return Response(user_item, mimetype="application/json", status=status_code)
...
class InvestmentTransactions(Resource):
    def get(self, access_token):
