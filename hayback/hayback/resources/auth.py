...
from hayback.models.userModel import retrieve_user, create_user
from hayback.models.accountModel import retrieve_account, retrieve_user_accounts
from hayback.resources.plaid.backend import get_transactions, get_balance, get_access_token
...
class RegisterApi(Resource):
    def post(self):
        ...
        if not user: 
            ...
            user_resp = create_user(email, first_name, last_name, password, phone_number)
            print(user_resp)
